...
using Ray2D = LockStepEngine.Collision2D.Ray2D;
...
namespace LockStepEngine
{
    public class PhysicSystem : BaseSystem
    {
        ...
        public override void OnStart()
        {
            ...
            debugService.Trace($"worldSize:{worldSize} pos:{pos} minNodeSize:{minNodeSize} loosenessval:{loosenessval}");
        ...
        public void RegisterEntity(int prefabId, Entity entity)
        {
            ...
            var fab = gameResourceService.LoadPrefab(prefabId) as GameObject;
