...
public class GLog : GLogger
{
    ...
    public static void Info(string message, Object sender = null) => I.DoLog(message, I.blackHEX, sender: sender);
    ...
    /// <summary>
    /// The error colored Log message
    /// </summary>
    /// <param name="message"> The message to be logged </param>
    /// <param name="sender"> Optional: The object the log message is comming from </param>
    public static void Error(string message, Object sender = null) => I.DoLog(message, I.dangerHEX, sender);
