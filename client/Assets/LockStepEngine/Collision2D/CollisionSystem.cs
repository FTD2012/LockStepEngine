...
namespace LockStepEngine.Collision2D
{
    ...
    public partial class CollisionSystem : ICollisionSystem
    {
        ...
        {
            GLog.Error($"QueryRegion layerType:{layerType} pos:{pos} size:{size}  forward:{forward} ");
        ...
        {
            GLog.Error($"QueryRegion layerType:{layerType} pos:{pos} radius:{radius} ");
            tempCallback = callback;
            _tempPos = pos;
            _tempRadius = radius;
        ...
        {
            GLog.Info($"ColliderProxy _CheckRegionOBB {obj.Id} trans{obj.Transform2D} col{obj.Prefab}");
        ...
        {
            GLog.Info($"ColliderProxy _CheckRegionCircle {obj.Id} trans{obj.Transform2D} col{obj.Prefab}");
